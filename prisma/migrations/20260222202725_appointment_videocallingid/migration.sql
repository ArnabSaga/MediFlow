/*
  ...
  - A unique constraint covering the columns `[striperEventId]` on the table `payments` will be added. If there are existing duplicate values, this will fail.
...
-- AlterTable
ALTER TABLE "payments" ADD COLUMN     "striperEventId" TEXT,
...
-- CreateIndex
CREATE UNIQUE INDEX "payments_striperEventId_key" ON "payments"("striperEventId");
